...
# 3 maneira
# dessa maneira posso pegar o número do index de cada valor e atribuir a uma varíável temporária
#               0, 1, 2, 3
#              (2,378.34,67)
...
alunos=[
    ...
    {"nome":"Maria","idade":22, "RG":"666.786.43-00"}
]
print(alunos[0] ["RG"])

#Estou cadastrando vários dicionarios em loop dentro da minha lista
